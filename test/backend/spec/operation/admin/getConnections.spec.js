...
var getConOp = require('../../../../../backend/operation/admin/getConnectionsOperation');
var account = require('../../../../../backend/entities/accountEntity');
var connection = require('../../../../../backend/entities/connectionEntity');
...
describe('Get connections', function () {
    ...
    it('returns list of connections', function (done) {
    ...
    it('returns connection info', function (done) {
        op.execute(function (response) {
            expect(response.error).toBeNull();
    ...
    it('filters by ip and action', function (done) {
        var filter;
...
//# sourceMappingURL=getConnections.spec.js.map