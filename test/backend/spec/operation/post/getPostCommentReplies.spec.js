...
describe('Get post comment replies', function () {
    var req;
    var op;
    var mock;
    ...
    it('returns list of replies', function (done) {
    ...
    it('returns total reply count', function (done) {
        op.execute(function (response) {
            expect(response.error).toBeNull();
    ...
    it('sorts replies by paw count', function (done) {
        op.execute(function (response) {
            expect(response.error).toBeNull();
    ...
    it('sorts replies by creation date if paw count is the same', function (done) {
        op.execute(function (response) {
            expect(response.error).toBeNull();
    ...
    it('returns reply info', function (done) {
        op.execute(function (response) {
            expect(response.error).toBeNull();
            expect(response.comments[0].text).toEqual(postWithComments.comments[2].text);
...
//# sourceMappingURL=getPostCommentReplies.spec.js.map